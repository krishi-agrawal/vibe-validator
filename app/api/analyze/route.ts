...
async function getRecommendationsFromQloo(vibeAnalysis: any, location: string = 'Delhi') {
    ...
    restaurants: [
      {
        ...
        confidence: 0.75,
        tags: [...aestheticKeywords.slice(0, 3), 'dining', 'restaurant'],
        rating: 4.2
      },
      {
        id: '2',
        ...
        confidence: 0.72,
        tags: [...moodDescriptors.slice(0, 2), 'contemporary', 'dining'],
        rating: 4.0
      }
    ],
    music: [
      {
        ...
        confidence: 0.80,
        tags: [...aestheticKeywords.slice(0, 2), 'playlist', 'ambient'],
        rating: 4.5
      },
      {
        id: '2',
        ...
        confidence: 0.76,
        tags: [...moodDescriptors.slice(0, 2), 'soundscape', 'ambient'],
        rating: 4.3
      }
    ],
    activities: [
      {
        ...
        confidence: 0.78,
        tags: [...aestheticKeywords.slice(0, 3), 'culture', 'gallery'],
        rating: 4.4
      },
      {
        id: '2',
        ...
        confidence: 0.74,
        tags: [...moodDescriptors.slice(0, 2), 'workshop', 'creative'],
        rating: 4.1
      }
    ],
    experiences: [
      {
        ...
        confidence: 0.77,
        tags: [...aestheticKeywords.slice(0, 3), 'tour', 'experience'],
        rating: 4.3
      },
      {
        id: '2',
        ...
        confidence: 0.73,
        tags: [...moodDescriptors.slice(0, 2), 'immersive', 'curated'],
        rating: 4.2
      }
    ]
  };
...
async function fetchQlooRecommendations(entityType: string, categoryTerms: string[], vibeKeywords: string[], location: string) {
  ...
  const searchTerms = [...categoryTerms, ...vibeKeywords.slice(0, 2)].join(' ');
